...
def aggregate_search():
    ...
    ol = safe_get('http://localhost:5000/api/openlibrary/search', {
    ...
    # Gutendex
    gu = safe_get('http://localhost:5000/api/gutendex/search', {
    ...
    # Knigafund
    kf = safe_get('http://localhost:5000/api/knigafund/search', {
